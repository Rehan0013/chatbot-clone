...
const Home = () => {
  ...
  const handleNewChat = async () => {
    ...
    const response = await axios.post(
      "https://chatbot-clone-z5zf.onrender.com/api/chat",
      {
        title,
      },
      {
  ...
  useEffect(() => {
    axios
      .get("https://chatbot-clone-z5zf.onrender.com/api/chat", {
        withCredentials: true,
      })
      .then((response) => {
    ...
    const tempSocket = io("https://chatbot-clone-z5zf.onrender.com", {
      withCredentials: true,
    });
  ...
  const getMessages = async (chatId) => {
    const response = await axios.get(
      `https://chatbot-clone-z5zf.onrender.com/api/chat/messages/${chatId}`,
      { withCredentials: true }
    );
